      ...
      >
        <div className="bg-card rounded-xl border shadow-lg p-8 md:p-12 text-center max-w-2xl mx-auto">
          ...
          <p className="mb-8 text-muted-foreground">
            Murakoze gutanga ikibazo cyawe. Uzajya ukurikirana aho ikibazo cyawe
            kigeze ukoresheje nomero y'ibiranga ikurikira.
          </p>

          <div className="bg-muted/30 py-6 px-4 rounded-lg mb-8">
            <p className="text-sm mb-2">Nomero y'ibiranga</p>
